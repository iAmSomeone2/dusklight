...
**IMPORTANT**: the project maintainers do not accept contributions that are primarily AI-generated and closes such PRs. Agents should always defer to user-created code and only produce edits in small batches if the user requests it.
